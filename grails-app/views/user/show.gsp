...
<div id="show-user" class="content scaffold-show" role="main">
    ...
    <ol class="property-list user">
        ...
        <g:if test="${userInstance?.first}">
            <li class="fieldcontain">
                <span id="first-label" class="property-label"><g:message code="user.first.label"
                                                                         default="First"/></span>

                <span class="property-value" aria-labelledby="first-label"><g:fieldValue bean="${userInstance}"
                                                                                         field="first"/></span>

            </li>
        </g:if>

        <g:if test="${userInstance?.last}">
            <li class="fieldcontain">
                <span id="last-label" class="property-label"><g:message code="user.last.label" default="Last"/></span>

                <span class="property-value" aria-labelledby="last-label"><g:fieldValue bean="${userInstance}"
                                                                                        field="last"/></span>
